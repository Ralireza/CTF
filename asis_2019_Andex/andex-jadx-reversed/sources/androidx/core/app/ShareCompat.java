...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        private IntentBuilder(Activity activity) {
            ...
            this.mIntent.putExtra(str, activity.getPackageName());
            this.mIntent.putExtra(str, activity.getPackageName());
            String str2 = "androidx.core.app.EXTRA_CALLING_ACTIVITY";
            this.mIntent.putExtra(str2, activity.getComponentName());
            this.mIntent.putExtra(str2, activity.getComponentName());
    ...
    public static String getCallingPackage(Activity activity) {
        ...
        return stringExtra == null ? activity.getIntent().getStringExtra(str) : stringExtra;
    }
    ...
    public static ComponentName getCallingActivity(Activity activity) {
        ...
        ComponentName componentName = (ComponentName) activity.getIntent().getParcelableExtra(str);
        return componentName == null ? (ComponentName) activity.getIntent().getParcelableExtra(str) : componentName;
    }
